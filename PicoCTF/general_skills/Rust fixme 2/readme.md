...
```console
┌──(rinto㉿LAPTOP-LUUOMDHF)-[~/CTF/picoRinto2/Rust-fixme2]
...
--2025-03-24 08:50:49--  https://challenge-files.picoctf.net/c_verbal_sleep/babfbee79718a6363826ba86300173ffde6d81577e9dd07d4130c53a7eecf6c3/fixme2.tar.gz
Resolving challenge-files.picoctf.net (challenge-files.picoctf.net)... 18.67.175.95, 18.67.175.86, 18.67.175.73, ...
Connecting to challenge-files.picoctf.net (challenge-files.picoctf.net)|18.67.175.95|:443... connected.
...
2025-03-24 08:50:50 (26.7 MB/s) - 'fixme2.tar.gz' saved [1585/1585]
```
...
## build cargo
```console
┌──(rinto㉿LAPTOP-LUUOMDHF)-[/tmp/rust_proj2]
└─$ cargo build
   ...
   Compiling rust_proj v0.1.0 (/tmp/rust_proj2)
...
setelah dilihat tenyata ada satu kesalahan dalam koding an tersbut yaitu kurang nya mutable references
...
```console
┌──(rinto㉿LAPTOP-LUUOMDHF)-[/tmp/rust_proj2/src]
└─$ cargo build                                                                                                                                                     
   Compiling rust_proj v0.1.0 (/tmp/rust_proj2)
...
└─$ cargo run                                                                                                                                                         
    Finished dev profile [unoptimized + debuginfo] target(s) in 0.23s
     Running /tmp/rust_proj2/target/debug/rust_proj
